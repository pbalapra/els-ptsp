...
To install the code, first obtain the file ELS-PTSP.v.1.0.tar.gz. 

Unzip the file by typing

gunzip ELS-PTSP.v.1.0.tar.gz

and then unpack it by typing 

tar -xvf ELS-PTSP.v.1.0.tar

The software will unpack in a new folder ELS-PTSP.v.1.0 

Go inside each directory and type 'make' to compile it under Linux; the executables 'ptspls' and 'evaluate' are produced.
